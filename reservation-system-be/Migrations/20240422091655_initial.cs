        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleModels_VehicleMake_VehicleMakeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleAvailability", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleAvailability_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerReservations_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAvailability_ReservationId",
                table: "VehicleAvailability",
                column: "ReservationId",
                unique: true);
