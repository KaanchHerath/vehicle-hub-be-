        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTelephone", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeTelephone_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalFeatures_VehicleModels_VehicleModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersReservation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomersReservation_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomersReservation_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomersReservation_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "CustomersReservation",
                column: "CustomerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomersReservation_ReservationId",
                table: "CustomersReservation",
                column: "ReservationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomersReservation_VehicleId",
                table: "CustomersReservation",
                column: "VehicleId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTelephone_EmployeeId",
